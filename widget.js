...
// Sidebar spin cooldown — element artık DOM'da, hemen güncelle
setTimeout(function(){if(window._mlUpdateSpinCooldown)window._mlUpdateSpinCooldown()},100);
// Confetti
setTimeout(function(){
...
window._mlUpdateSpinCooldown=function(){
  ...
  if(typeof _swGetCooldownEnd!=='function'){
    // spinwheel.js henüz yüklenmemişse localStorage'dan direkt oku
    try{var s=localStorage.getItem('sw_cooldown');if(s){var v=parseInt(s);if(v>Date.now()){var ms=v-Date.now();var h=Math.floor(ms/3600000),m=Math.floor((ms%3600000)/60000);el.textContent=h>0?h+'s '+m+'dk':m+'dk';return}}}catch(e){}
...
setTimeout(function(){if(window._mlUpdateSpinCooldown)window._mlUpdateSpinCooldown()},2000);
})();
