...
var spinHtml='<div class="ml-acc-hdr" id="ml-acc-spin" onclick="event.stopPropagation();var _b=document.getElementById(\'ml-acc-bday\');if(_b)_b.classList.remove(\'open\');var _r=document.getElementById(\'ml-acc-ref\');if(_r)_r.classList.remove(\'open\');mlAccToggle(\'ml-acc-spin\');"><div class="ml-acc-title"><svg viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;stroke:var(--mlg);stroke-width:2;fill:none"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="2.5"/><line x1="12" y1="2" x2="12" y2="9.5"/><line x1="12" y1="14.5" x2="17" y2="20"/><line x1="12" y1="14.5" x2="7" y2="20"/></svg>Çarkı Çevir <span id="ml-spin-cd" style="display:inline-block;font-weight:500;font-size:8px;color:var(--mlg);border:1px solid rgba(175,140,62,.25);border-radius:4px;padding:1px 5px;margin-left:6px;vertical-align:1px;letter-spacing:.3px"></span></div><svg class="ml-acc-chev" viewBox="0 0 24 24"><path d="M6 9l6 6 6-6"/></svg></div><div class="ml-acc-body"><div class="ml-spin-sec" onclick="event.stopPropagation()"><div class="ml-spin-badge">Şansını Dene</div><button class="ml-spin-btn" onclick="event.stopPropagation();if(typeof openOverlay===\'function\')openOverlay();"><svg viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="2.5"/><line x1="12" y1="2" x2="12" y2="9.5"/><line x1="12" y1="14.5" x2="17" y2="20"/><line x1="12" y1="14.5" x2="7" y2="20"/></svg>Çarkı Çevir</button></div></div>';
...
// Sayfa yüklendiğinde cooldown kontrol
